...
Generally, organic matter fluxes were dominated by insect species from *Simuliidae* and *Chironomidae* families (Figure 1a). In warmer streams, OM fluxes shifted toward the pulmonate snail, *Radix balthica*. In the warmest stream, where maximum temperatures approach ~40$^\circ$C, OM fluxes were dominated by worms of family *Naididae*, the midge *Cricotpous sylvestris*, and *Radix balthica*.    

```{r figure 1, echo = FALSE, warning = FALSE, message = FALSE, fig.width=7.5, fig.height=6, dpi = 450, fig.cap="Figure 1. Patterns of OM flux among populations based on (a) Rank ordering of annual population organic matter flux log~e~(mg m^-2^ y^-1^) and (b) relative OM flux among taxaonomic groups in consumer communities and across the temperature gradient."}
