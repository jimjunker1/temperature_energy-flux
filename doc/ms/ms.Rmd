...
replacement (*n* = 1000) and growth rates estimated from equation 1. We prevented the calculation of negative growth rates by requiring $W_{t + \Delta t}$ \> $W_t$. To estimate
...
[@diaz] SAD are more uneven than their statistical background
