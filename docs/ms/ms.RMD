...
Increasing global temperatures are altering the diversity, structure, and functioning of Earth's ecosystems [@Brose2012][@walther2002][@Woodward_Dybkjær_Ólafsson_eta2010]. The effects of this warming manifest through shifting species ranges [],  

The provision and maintenance of ecosystem functions are underpinned by the network of species interactions across which energy, materials, and information are exchanged [@deRuiter1995][@thompson2012]. Specifically, warming can directly alter , is tied to the magnitudes and relative distributions of energy fluxes among species and trophic levels [@may1972][@barnes2018]. 
